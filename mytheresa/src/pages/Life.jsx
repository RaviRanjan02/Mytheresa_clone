...
import styles from "../pages/Life.module.css";
...
const Life = () => {
    ...
    const getLife = async () => {
      const response = await fetch("https://mytheresabackend.herokuapp.com/Life");
      ...
      <div className={styles.Life_page_main_layout}>
        <div className={styles.Life_breadcurms}>
          <div className={styles.Life_breadcurms_features}>
            <Breadcrumb>
              <BreadcrumbItem>
                <BreadcrumbLink href="#">Life</BreadcrumbLink>
              </BreadcrumbItem>
        ...
        <hr></hr>
        <div className={styles.Life_Sale_Non_sale}>
          <div className={styles.Life_Sale_Non_main}>
            <div className={styles.Life_Sale_Non_title}>Sale</div>
            <div className={styles.Life_Sale_Non_check}>
              <Checkbox />
            </div>
          </div>
          <div className={styles.Life_Sale_Non_main}>
            <div className={styles.Life_Sale_Non_title}>Non-sale</div>
            <div className={styles.Life_Sale_Non_check}>
              <Checkbox />
            </div>
          </div>
          <div className={styles.Life_Sale_Non_main}>
            <div className={styles.Life_Sale_Non_title}>Show all</div>
            <div className={styles.Life_Sale_Non_check}>
              <Checkbox />
            </div>
          </div>
        ...
        <hr></hr>
        <div className={styles.Life_product_Main_container}>
          <div className={styles.Life_product_Main_container_left}>
            <div>
          ...
          <div className={styles.Life_product_Main_container_Right}>
           {life.map((e,id)=>{
            return(
            <div className={styles.Life_product_Main_container_Right_layout}>
              <div
                className={styles.Life_product_Main_container_Right_product}
              >
                <div>
                  <img
                    src={e.image}
                ...
                <div
                  className={
                    styles.Life_product_Main_container_Right_product_price
                  }
                >
                  {e.price}
                </div>
                <div
                  className={
                    styles.Life_product_Main_container_Right_product_button
                  }
                >
                  <div>
                    {" "}
