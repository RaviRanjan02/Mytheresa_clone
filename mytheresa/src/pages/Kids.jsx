  ...
  return (
    <div className={styles.Kids_Main}>
      <div className={styles.Kids_page_main_layout}>
        ...
        <hr></hr>
        <div className={styles.Kids_Sale_Non_sale}>
          <div className={styles.Kids_Sale_Non_main}>
            <div className={styles.Kids_Sale_Non_title}>Sale</div>
            <div className={styles.Kids_Sale_Non_check}>
              <Checkbox />
            </div>
          </div>
          <div className={styles.Kids_Sale_Non_main}>
            <div className={styles.Kids_Sale_Non_title}>Non-sale</div>
            <div className={styles.Kids_Sale_Non_check}>
              <Checkbox />
            </div>
          </div>
          <div className={styles.Kids_Sale_Non_main}>
            <div className={styles.Kids_Sale_Non_title}>Show all</div>
            <div className={styles.Kids_Sale_Non_check}>
              <Checkbox />
            </div>
          </div>
        ...
        <hr></hr>
        <div className={styles.Kids_product_Main_container}>
          <div className={styles.Kids_product_Main_container_left}>
            <div>
          ...
          <div className={styles.Kids_product_Main_container_Right}>
            {kids.map((e, id) => {
              return (
                <div
                  className={styles.Kids_product_Main_container_Right_layout}
                >
                  <div
                    className={styles.Kids_product_Main_container_Right_product}
                  >
                    <div>
                      <img src={e.image} alt="" />
                    </div>
                    ...
                    <div
                      className={
                        styles.Kids_product_Main_container_Right_product_price
                      }
                    >
                      {e.price}
                    </div>
                    <div
                      className={
                        styles.Kids_product_Main_container_Right_product_button
                      }
                    >
                      <div>
                        {" "}
