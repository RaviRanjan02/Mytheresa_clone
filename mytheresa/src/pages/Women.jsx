...
const Women = () => {
  ...
  return (
    <div className={styles.Womens_Main}>
      <div className={styles.Womens_page_main_layout}>
        <div className={styles.Womens_breadcurms}>
          <div className={styles.Womens_breadcurms_features}>
            <Breadcrumb>
              <BreadcrumbItem>
                <BreadcrumbLink href="#">Womens</BreadcrumbLink>
              </BreadcrumbItem>
        ...
        <hr></hr>
        <div className={styles.Womens_Sale_Non_sale}>
          <div className={styles.Womens_Sale_Non_main}>
            <div className={styles.Womens_Sale_Non_title}>Sale</div>
            <div className={styles.Womens_Sale_Non_check}>
              <Checkbox />
            </div>
          </div>
          <div className={styles.Womens_Sale_Non_main}>
            <div className={styles.Womens_Sale_Non_title}>Non-sale</div>
            <div className={styles.Womens_Sale_Non_check}>
              <Checkbox />
            </div>
          </div>
          <div className={styles.Womens_Sale_Non_main}>
            <div className={styles.Womens_Sale_Non_title}>Show all</div>
            <div className={styles.Womens_Sale_Non_check}>
              <Checkbox />
            </div>
          </div>
        ...
        <hr></hr>
        <div className={styles.Womens_product_Main_container}>
          <div className={styles.Womens_product_Main_container_left}>
            <div>
          ...
          <div className={styles.Womens_product_Main_container_Right}>
            {womens.map((e,id)=>{
                return(
                    <div className={styles.Womens_product_Main_container_Right_layout}>
              <div
                className={styles.Womens_product_Main_container_Right_product}
              >
                <div>
                  <img
                    src={e.image}
                ...
                <div
                  className={
                    styles.Womens_product_Main_container_Right_product_price
                  }
                >
                  {e.price}
                </div>
                <div
                  className={
                    styles.Womens_product_Main_container_Right_product_button
                  }
                >
                  <div>
                    {" "}
